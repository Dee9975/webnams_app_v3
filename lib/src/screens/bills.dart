    ...
    return ListView.builder(
      ...
      itemBuilder: (context, int index) {
        ...
        return GestureDetector(
          onTap: () {
            Provider.of<DashModel>(context, listen: false).updateSelectedBill(Provider.of<DashModel>(context, listen: false).bills.data[index]);
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Text(
                        'Rēķina Nr: ${Provider.of<DashModel>(context).bills.data[index].iD}',
                ...
                Padding(
                  ...
                  child: Text(
                    'Apmaksāt līdz: ${Provider.of<DashModel>(context).bills.data[index].date}',
                    style: TextStyle(
                        fontSize: 16.0,
