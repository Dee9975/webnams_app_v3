...
class MyFlutterApp {
  ...
  static const IconData skait = IconData(0xe800, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData rekins = IconData(0xe801, fontFamily: _kFontFam, fontPackage: _kFontPkg);
